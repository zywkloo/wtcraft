...
> This file is the stable task specification. Mutable lifecycle and check/
> verification results live in `.worktree-state.json`; update them through
> `wtcraft state`, `wtcraft check`, and `wtcraft verify`, not in this Markdown.
